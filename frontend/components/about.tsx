...
const statements = [
  "We are creating a marketplace where people can share access to real world interaction data.",
  "Images and videos paired with their DEPTH INFORMATION, ensuring no AI generated counterfeits.",
  "Royalty enabled by IP on story, making sure every company using a person's data gets them their royalty.",
  "Share & Monetize REAL real-world data (not AI).",
  "Every piece of data is verified, authentic, and protected.",
]
  ...
  return (
    <section ref={containerRef} className="relative py-32 overflow-hidden md:py-0">
      ...
      >
        ...
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Authentic Data Marketplace</h2>
      </motion.div>
