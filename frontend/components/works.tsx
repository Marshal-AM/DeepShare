...
const projects = [
  {
    title: "Depth-Verified Data",
    tags: ["Real Data", "Depth Info", "Authentic"],
    image: "/abstract-neural-network-visualization-dark-theme.jpg",
    year: "01",
  },
  {
    title: "Images & Videos",
    tags: ["Real World", "Verified", "Monetized"],
    image: "/futuristic-data-dashboard-dark-minimal.jpg",
    year: "02",
  },
  {
    title: "IP-Protected",
    tags: ["Royalty", "Ownership", "Secure"],
  ...
  return (
    <section className="relative py-32 px-8 md:px-12 md:py-24">
      ...
      <motion.div
        ...
        className="mb-24"
      >
        <h2 className="font-sans text-3xl md:text-5xl font-light italic">Verified Data Collections</h2>
      </motion.div>
