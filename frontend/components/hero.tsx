    ...
    <section ref={containerRef} className="relative h-screen w-full overflow-hidden bg-[#050505]">
      ...
      <motion.div style={{ opacity, scale }} className="relative z-10 h-full flex flex-col justify-between p-8 md:p-12 md:px-12 md:py-20">
        ...
        <motion.div
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex gap-6"
        >
          <motion.button
            data-cursor-hover
            ...
            whileTap={{ scale: 0.95 }}
            className="relative px-12 py-6 border border-white/20 rounded-full font-mono text-base tracking-widest uppercase bg-transparent backdrop-blur-sm hover:bg-white hover:text-black transition-colors duration-500"
          >
            Dashboard
        ...
        >
          <h3 className="font-sans text-2xl md:text-4xl lg:text-5xl font-light tracking-tight text-balance">
            Real Media Datasets with depth data,<br />
            not AI slop
          </h3>
        </motion.div>
      </motion.div>
